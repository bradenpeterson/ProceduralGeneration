...
public partial class MainMenu : Control
{
	public override void _Ready()
	{
		...
		GetNode<Button>("VBoxContainer/BinarySpacePartitioningButton").Pressed += GameManager.Instance.GoToBinarySpacePartitioning;
		GetNode<Button>("VBoxContainer/RandomWalkButton").Pressed += GameManager.Instance.GoToRandomWalk;
